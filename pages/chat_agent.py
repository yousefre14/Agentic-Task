...
_VALID_PHONE_PATTERNS = [
    (re.compile(r"^(\+20|0020|0)?1[0125]\d{8}$"),   "مصر — 010/011/012/015 + 8 أرقام"),
    (re.compile(r"^(\+966|00966|0)?5\d{8}$"),        "السعودية — 05X + 8 أرقام"),
    (re.compile(r"^(\+971|00971|0)?5[024568]\d{7}$"),"الإمارات — 05X + 7 أرقام"),
    (re.compile(r"^(\+962|00962|0)?7[789]\d{7}$"),   "الأردن — 077/078/079 + 7 أرقام"),
    (re.compile(r"^(\+963|00963|0)?9[0-9]\d{7}$"),   "سوريا — 09X + 7 أرقام"),
    (re.compile(r"^(\+961|00961|0)?[37]\d{7}$"),     "لبنان — 03/07 + 7 أرقام"),
    (re.compile(r"^(\+965|00965)?[569]\d{7}$"),      "الكويت — 5/6/9 + 7 أرقام"),
]
